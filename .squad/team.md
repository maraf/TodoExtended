...
> TodoExtended — .NET 9 Blazor application built from specs
...
|------|------|---------|--------|
| Architect | Lead / Solution Architect | [charter](agents/architect/charter.md) | ✅ Active |
...
- **Stack:** .NET 9, Blazor, Entity Framework Core, xUnit, bUnit
- **Approach:** Spec-driven — all features start from written specifications
- **Created:** 2026-03-05
