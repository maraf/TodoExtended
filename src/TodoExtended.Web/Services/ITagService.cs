...
public interface ITagService
{
    ...
    /// <summary>Returns non-deleted tasks that have a given tag. When <paramref name="onlyUncompleted"/> is true, only uncompleted tasks are returned.</summary>
    Task<IReadOnlyList<TodoTaskWithList>> GetTasksByTagAsync(string tag, string userId, bool onlyUncompleted = false);
